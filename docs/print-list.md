...
**Still to print:** the circuitry mounting plate (on the printer on 2026-09-20), the three LiPo
brackets, then group 2.
...
| `Circuitry_Mountingplate_SZBK07_Extended.stl` | 1 | no | 20% | 66g | **Pick the SZBK07 version**, not the XL4016: that is the big step-down on this build |
